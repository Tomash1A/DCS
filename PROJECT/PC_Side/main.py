...
def pc_side(inChar, input_file):
    ...
    while True:
        ...
        while (s.in_waiting > 0 or enableRX):  # while the input buffer isn't empty
            ...
            if state == 0:
            ...
            elif state == 3 and s.in_waiting > 0:
                ...
                break
            elif state == 8 and s.in_waiting > 0:  # Script 1 finished
                A = s.readline().decode().strip()
                if (A == '8'):
                    print('Script 1 finished running on MCU')
                break
            elif state == 9 and s.in_waiting > 0:  # Script 2 finished
                A = s.readline().decode().strip()
                if (A == '9'):
                    print('Script 2 finished running on MCU')
                break
            elif state == 10 and s.in_waiting > 0:  # Script 3 finished
                A = s.readline().decode().strip()
                if (A == 'A'):
                    print('Script 3 finished running on MCU')
                break
